...
var ShareInstance = function(options) {
  ...
  if (options.backend) {
    ...
    var livedb_options = options.db;
    if (options.redis) { livedb_options.redis = options.redis; }
    if (options.redisObserver) { livedb_options.redisObserver = options.redisObserver; }
